...
url(r'^(?P<location_id>[0-9]+)/spares', views.spares, name='spares'),
url(r'^(?P<location_id>[0-9]+)/batteries', views.batteries, name='batteries'),
url(r'^(?P<location_id>[0-9]+)/tyres', views.tyres, name='tyres'),
